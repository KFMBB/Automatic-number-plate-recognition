...
while isReadingFrames:
    ...
    if isReadingFrames:
        ...
        detections = model(frame)[0]  # the [0] will unpack the models bbox, confidence and class_id as a tuple.
        ...
        for detection in detections.boxes.data.tolist():
            ...
            if int(class_id) in vehicles:  # If the object detected is a vehicle:
                vehicles_detected.append(
                    [x1, y1, x2, y2, score])  # Add bbox, confidence to the list of detected vehicles.
